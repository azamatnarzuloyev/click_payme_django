from config.config import payme_settings
import base64
from decimal import Decimal

assert payme_settings.PAYCOM_SETTINGS.get('KASSA_ID') != None
assert payme_settings.PAYCOM_SETTINGS.get('ACCOUNTS') != None
assert payme_settings.PAYCOM_SETTINGS['ACCOUNTS'].get('KEY') != None

TOKEN = payme_settings.PAYCOM_SETTINGS['KASSA_ID']
KEY = payme_settings.PAYCOM_SETTINGS['ACCOUNTS']['KEY']
